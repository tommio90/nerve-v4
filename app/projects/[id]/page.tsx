    ...
    <div className="synapse-page animate-fade-in space-y-5">
      ...
      <div className="grid gap-4 xl:grid-cols-[1fr_320px]">
        <div className="space-y-4">
          <Card className="border-violet/25 p-0">
          ...
          <Card className="p-0">
            ...
            <CardContent className="space-y-4 p-3 pt-4 sm:p-5 sm:pt-4">
              ...
              {totalTasks === 0 ? (
                <div className="flex flex-col items-center gap-2 rounded-lg border border-dashed border-border py-8 text-center">
                  ...
                  <p className="text-subtle">No tasks yet. Generate tasks with AI to get started.</p>
                </div>
              ) : (
                <TaskKanban
        ...
        <div className="space-y-4">
          {project.whitepaperDocId ? (
            <Card className="border-cyan/20 p-0">
